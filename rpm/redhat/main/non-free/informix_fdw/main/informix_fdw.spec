...
%build
PATH=/opt/IBM/Informix/bin:$PATH INFORMIXDIR=/opt/IBM/Informix USE_PGXS=1 %{__make} %{?_smp_mflags} %{with_llvm_arg}

%install
%{__rm} -rf %{buildroot}
USE_PGXS=1 %{__make} %{?_smp_mflags} %{with_llvm_arg} install DESTDIR=%{buildroot}
...
%changelog
* Sun Aug 30 2026 Devrim Gunduz <devrim@gunduz.org> - 0.6.3-2PGDG

...
%description llvmjit
This package provides JIT support for PostGIS 3.2
%endif
...
* Mon Dec 8 2025  Devrim Gunduz <devrim@gunduz.org> - 3.2.8-15PGDG
- Build with GDAL 3.12 on all platforms except RHEL 8 and SLES 15.

* Wed Nov 12 2025 Devrim Gunduz <devrim@gunduz.org> - 3.2.8-14PGDG
...
* Mon Nov 10 2025 Devrim Gunduz <devrim@gunduz.org> - 3.2.8-13PGDG
- Update pcre2 and libxerces dependencies on SLES.

* Tue Oct 7 2025 Devrim Gunduz <devrim@gunduz.org> - 3.2.8-12PGDG
- Rebuild against PROJ 9.7 on all platforms except RHEL 8
- Add SLES 16 support

* Wed Oct 01 2025 Yogesh Sharma <yogesh.sharma@catprosystems.com> - 3.2.8-11PGDG
- Bump release number (missed in previous commit)

* Tue Sep 30 2025 Yogesh Sharma <yogesh.sharma@catprosystems.com>
- Change => to >= in Requires and BuildRequires

* Wed Aug 27 2025 Devrim Gündüz <devrim@gunduz.org> - 3.2.8-10PGDG
...
* Sun May 25 2025 Devrim Gündüz <devrim@gunduz.org> - 3.2.8-7PGDG
- Keep using PROJ 9.5 and GDAL 3.10. Use GDAL 3.11 where available.

* Wed Apr 16 2025 Devrim Gündüz <devrim@gunduz.org> - 3.2.8-6PGDG
- Rebuild against PROJ 9.6

* Sat Mar 8 2025 Devrim Gündüz <devrim@gunduz.org> - 3.2.8-5PGDG
...
* Tue Dec 24 2024 Devrim Gunduz <devrim@gunduz.org> - 3.2.8-2PGDG

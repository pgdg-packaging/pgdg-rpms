...
%install
%{__rm} -rf %{buildroot}
PATH=%{pginstdir}/bin:$PATH USE_PGXS=1 %make_install %{with_llvm_arg} install DESTDIR=%{buildroot}
...
* Fri Aug 7 2026 Devrim Gunduz <devrim@gunduz.org> - 4.6-2PGDG
- Add Amazon Linux 2023 support.

* Mon Jul 20 2026 Devrim Gündüz <devrim@gunduz.org> - 4.6-1PGDG
- Update to 4.6 per changes described at:
  https://github.com/darold/pgtt/releases/tag/v4.6

* Tue Jun 30 2026 Devrim Gündüz <devrim@gunduz.org> - 4.5-2PGDG
- Rebuild because of package signing issue on some platforms

* Fri Jun 19 2026 Devrim Gündüz <devrim@gunduz.org> - 4.5-1PGDG
- Update to 4.5 per changes described at:
  https://github.com/darold/pgtt/releases/tag/v4.5

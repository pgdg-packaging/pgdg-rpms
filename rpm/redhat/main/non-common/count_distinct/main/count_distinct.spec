...
%install
%{__rm} -rf %{buildroot}
USE_PGXS=1 PATH=%{pginstdir}/bin/:$PATH %{__make} DESTDIR=%{buildroot} %{?_smp_mflags} install %{with_llvm_arg}
...
%changelog
* Sun Aug 30 2026 Devrim Gunduz <devrim@gunduz.org> - 3.0.2-5PGDG
